...
DROP TABLE IF EXISTS AssignacioTurista;
DROP TABLE IF EXISTS Agencia;
DROP TABLE IF EXISTS Contractacio;
DROP TABLE IF EXISTS Actual;
DROP TABLE IF EXISTS Antiguitat;
DROP TABLE IF EXISTS Director;
DROP TABLE IF EXISTS Empleat;
DROP TABLE IF EXISTS Pertany;
DROP TABLE IF EXISTS CadenaHotelera;
DROP TABLE IF EXISTS Localitzacio;
DROP TABLE IF EXISTS Ciutat;
DROP TABLE IF EXISTS NivellQualitat;
DROP TABLE IF EXISTS Activitat;
DROP TABLE IF EXISTS DeMuntanya;
DROP TABLE IF EXISTS DePlatja;
